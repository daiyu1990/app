			...
			<form action="" class="">
				<ul class="ls_wrap  cir_blue ls_model">
					...
					<li>
						...
						<span class="ls_fr">
					<input type="text"  class="" required placeholder="请选择工程编号"  v-model='code'/>			
					</span>
					...
					<li>
						...
						<span class="ls_fr">
					<input type="text"  required placeholder="请输入工程名称" v-model='name' />
					...
					<li>
						...
						<span class="ls_fr">
					<input type="text"    placeholder="手动输入" v-model='address' />
				...
				<button type="submit" class="sub_btn" @click='subss'>提交</button>
				<!--</router-link>-->
...
<script>
	...
	export default {
		...
		methods: {
			subss: function(ev) {
				var that = this
				// 调取地图的经纬度值并传输此数值，判断的时候加上address
