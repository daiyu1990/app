	...
	<div class="res_lo">
		...
		<form id="form1" class="form-horizontal" role="form">
			...
			<div class="form-group">
				<label class="col-xs-1 control-label"><img src="../../../static/flyda_img/login/users.png"/></label>
				<div class="col-xs-10">
			...
			<button type="button" class="wechat" @click='slideup'><span class="fa fa-wechat " style="font-size: 20px;margin-top: 3px;margin-right: 10px;"></span> 微信登录 </button>
			<!--weixin-->
...
<!--<script src="../../assets/js/fetch.js" type="text/javascript" charset="utf-8"></script>-->
<script>
	import Qs from 'qs'
	...
	export default {
		...
		methods: {
			...
			getvercode: function() {
				var that = this
				//				fetch('http://flyda/Api/Login/verify_code', {
				//						mode: 'cors',
				//
				//					}).then((res) => res.text())
				//					.then(data => {
