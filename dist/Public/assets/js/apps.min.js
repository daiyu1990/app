...
var handleSidebarMenu = function() {
    ...
    $(".sidebar .nav > .has-sub > a").click(function() {
        ...
        if($(e).parent('li').hasClass('expand')){
            $(e).parent('li').removeClass('expand');
            $(e).slideUp(250);
        } else {
            $(e).parent('li').addClass('expand');
            $(e).slideDown(250);
        }
    ...
    // $(".sidebar .nav > .has-sub .sub-menu li.has-sub > a").click(function() {alert('efg');
    //     if ($(".page-sidebar-minified").length === 0) {
    //         var e = $(this).next(".sub-menu");
    //         $(e).slideToggle(250)
    //     }
...
var handleThemePageStructureControl = function() {
    if ($.cookie && $.cookie("theme")) {
        ...
        var e = "/Public/assets/css/theme/" + $.cookie("theme") + ".css";
        $("#theme").attr("href", e)
    }
    ...
    function() {
        var e = "/Public/assets/css/theme/" + $(this).attr("data-theme") + ".css";
        $("#theme").attr("href", e);
